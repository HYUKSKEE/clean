    ...
    >
      <div className="container-page">
        <SectionHeading
          ...
          title={<span id="area-title">서울 · 경기 · 인천 전 지역 출장</span>}
          description="수도권은 출장비 없이 방문 상담이 가능합니다. 지역별 오염 특성을 반영해 시공 방법을 다르게 적용합니다."
        />
            ...
            <li key={region.name}>
              <article className="flex h-full flex-col rounded-2xl border border-line bg-white p-6">
                <h3 className="flex items-center gap-2 text-xl font-bold">
                  <span className="grid size-9 place-items-center rounded-lg bg-brand-soft text-sm font-extrabold text-brand-deep">
        ...
        <div className="mt-8 flex flex-col items-center gap-5 rounded-2xl border border-line bg-white p-6 text-center lg:flex-row lg:justify-between lg:p-8 lg:text-left">
          <div>
            <h3 className="text-lg font-bold sm:text-xl">
              목록에 없는 지역도 문의해 주세요
            </h3>
            <p className="mt-2 text-[0.925rem] leading-relaxed text-ink-soft">
              수도권 외 지역도 규모와 일정에 따라 시공 가능합니다. 건물 위치를 알려주시면 출장 가능
              여부를 바로 확인해 드립니다.
            </p>
